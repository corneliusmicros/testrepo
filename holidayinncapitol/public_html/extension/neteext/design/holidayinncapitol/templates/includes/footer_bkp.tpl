...
<div id="footer-area">
		<div id="footer-left">				
			<ul>
				...
				<li><a href="#" target="_blank" class="twitter" title="Twitter">Twitter</a></li>
				<li><a href="#" target="_blank" class="facebook" title="Facebook">Facebook</a></li>
		...
		<div id="footer-content">
			...
			<div id="copyright">
				<p>&copy;{currentdate()|datetime('custom','%Y')} Holiday Inn. All rights reserved. <a href="http://www.tigglobal.com" target="_blank" title="Hotel Internet Marketing" class="copy">Hotel Internet Marketing</a> by TIG Global</p>
			</div>
		</div>		
	</div>
