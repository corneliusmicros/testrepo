...
$oldSetArray_4f7553ee2c094d2d9f357ffdb2fbcae3 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'anchor_name', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['anchor_name'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
$setArray = $oldSetArray_4f7553ee2c094d2d9f357ffdb2fbcae3;
$tpl->Level--;
?>
